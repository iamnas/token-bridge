...
import './App.css';
import { BNB_BRIDGE, BNB_TOKEN, BRIDGE_ABI, SEPOLIA_BRIDGE, SEPOLIA_TOKEN, TOKEN_ALLOWANCE_ABI } from "./utils/account";
...
function App() {
  ...
  useEffect(() => {
    setIsAllowanceSufficient(Number(allowance) > amount);
  }, [allowance, amount]);
